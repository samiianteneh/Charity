    ...
    <section className=" font-poppins text-gray-600 body-font relative">
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="md:w-2/3  bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          ></iframe>
          <div className="bg-white md:relative md:flex md:flex-wrap py-6 rounded shadow-md md:w-full md:px-6 md:mt-4">
        ...
        <div className="md:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
