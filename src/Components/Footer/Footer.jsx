      ...
      <footer className=" bg-gray-800 text-white font-poppins">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <a
              href="https://twitter.com/Hebir02"
            ...
            <a
              href="https://www.instagram.com/hebret01/"
              className="ml-3 text-gray-500"
            >
              <svg
                fill="none"
      ...
      {/* <footer className=" bg-gray-800 text-white font-poppins">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <a
              href="#home"
              className="flex font-poppins font-medium items-center md:justify-start justify-center text-white"
            >
              <img src={logo} alt="logo" className="w-20 md:w-40" />
            </a>
            <p className="mt-2 text-sm text-white">
          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="font-poppins font-medium text-white tracking-widest text-sm mb-3">
                CATEGORIES
              </h2>
